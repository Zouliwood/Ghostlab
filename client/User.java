...
public class User {
    ...
    private static Historique hist;
    ...
    static class ConnectServerTCP implements Runnable {
        ...
        public ConnectServerTCP(String hostName, int port, String fileName) {
            this.port = port;
            this.hostName = hostName;
        ...
        public void run() {
            try {
                ...
                try (FileInputStream fis = new FileInputStream(this.fileName);
                    ...
                    User.hist = (Historique) ois.readObject();
                    ...
                    User.hist=new Historique();
                    User.hist.setPseudo(pseudoClient);
                }
